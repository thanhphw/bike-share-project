...
def get_filters():
    ...
    while city not in ['chicago', 'new york city', 'washington']:
        city = input("kindly choose from (chicago, new york city, washington): ").lower()
...
def user_stats(df):
    ...
    if 'Gender' in df:
        ...
        print('Gender stats is not in the dataframe')
    ...
    if 'Birth Year' in df:
        ...
        print('Birth year is not in the dataframe')
...
def disp_data(df):
    """ Displays 5 rows of selected data """
